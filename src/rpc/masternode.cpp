...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print bitlioncoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitlioncoin",               "masternode",             &masternode,             true,  {} },
    { "bitlioncoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitlioncoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bitlioncoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "bitlioncoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "bitlioncoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
