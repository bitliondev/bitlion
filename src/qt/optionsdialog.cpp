    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BTLC-light"), QVariant("light"));
    ui->theme->addItem(QString("BTLC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BTLC-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BTLC-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BTLC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BTLC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BTLC-traditional"), QVariant("trad"));
