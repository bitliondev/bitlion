...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a bitlioncoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitlioncoin: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about bitlioncoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your bitlioncoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified bitlioncoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitlioncoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible bitlioncoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to bitlioncoin network", "", count));
    } else {
...
{
    QString strTitle = tr("bitlioncoin Core"); // default title
    ...
    // Append title to "bitlioncoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
