    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitlioncoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the bitlioncoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BTLC, 0.1 BTLC, 1 BTLC and 10 BTLC -- sort of like the paper money you use every day.</li> \
