...
2. run bitlioncoind with -printalert or -sendalert like this:
   /path/to/bitlioncoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitlioncoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/bitlioncoin Core:0.12.0.58/"));
