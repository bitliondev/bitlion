...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitlioncoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitlioncoin address" in e.error['message'])
