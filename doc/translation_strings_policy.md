...
This document provides guidelines for internationalization of the bitlioncoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitlioncoin_en.ts` remains unchanged.
