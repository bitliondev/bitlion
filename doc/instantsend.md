...
This mechanism has been integrated into Bitcore-Node-bitlioncoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitlioncoinpay/insight-api-bitlioncoin#web-socket-api](https://github.com/bitlioncoinpay/insight-api-bitlioncoin#web-socket-api)
* API: [https://github.com/bitlioncoinpay/insight-api-bitlioncoin#instantsend-transactions](https://github.com/bitlioncoinpay/insight-api-bitlioncoin#instantsend-transactions)
...
By default, the bitlioncoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the bitlioncoin Core daemon:
